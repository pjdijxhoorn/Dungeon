DROP TABLE IF EXISTS Training, Fitness_profile, player_base_stats, Monsters, Encounters, Gear,equipped_gear, Clan, player;
...
VALUES
  ...
  ('delete', '$2a$12$2sNbJyNfNbmhkhHozOnJJ.Ae8LwpqYbmznJRSLfbJBVz095SBJPXC', 'player for delete', 675, '{125, 130, 135, 140, 145}', 0.43);
...
INSERT INTO Training (training_name, distance_in_meters, time_in_seconds, average_speed, training_type, base_score, training_date, player_id, dungeon_status)
VALUES
('Morning run', 8000, 1800, 10, 'Sprint', 75, TO_DATE('16-01-2024', 'DD-MM-YYYY'), 1, TRUE),
...
('Evening Walk', 3000, 1800, 5, 'Endurance', 60, TO_DATE('21-01-2024', 'DD-MM-YYYY'), 5, TRUE),
('Hill Climb', 4000, 2400, 4, 'Endurance', 65, TO_DATE('22-01-2024', 'DD-MM-YYYY'), 6, FALSE),
('Speed Run', 5000, 1500, 10, 'Sprint', 70, TO_DATE('23-01-2024', 'DD-MM-YYYY'), 7, TRUE),
('Trail Run', 6000, 2700, 6.66, 'Endurance', 75, TO_DATE('24-01-2024', 'DD-MM-YYYY'), 8, TRUE),
...
('Forest Hike', 9000, 3600, 5, 'Endurance', 65, TO_DATE('27-01-2024', 'DD-MM-YYYY'), 11, TRUE),
('Mountain Trek', 10000, 4800, 3.75, 'Endurance', 70, TO_DATE('28-01-2024', 'DD-MM-YYYY'), 12, TRUE),
...
INSERT INTO Monsters (name, defence, strenght, health, speed, accuracy, zone_difficulty)
VALUES
('Rat', 2, 2, 3, 4, 4, 'easy'),
('sturdy potted plant', 5, 0, 20, 0, 0, 'easy'),
...
INSERT INTO Encounters (encounter_text, encounter_stat_type, encounter_stat)
VALUES
